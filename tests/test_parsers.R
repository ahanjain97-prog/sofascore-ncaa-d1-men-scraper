...
stopifnot(tables$team_statistics$home_team_id[[1L]] == 329974L)
stopifnot(tables$team_statistics$home_team_name[[1L]] == "Northern Illinois Huskies")
stopifnot(tables$team_statistics$away_team_id[[1L]] == 329901L)
stopifnot(tables$team_statistics$away_team_name[[1L]] == "UIC Flames")
...
stopifnot(event_date_in_timezone(event, "America/Chicago") == as.Date("2026-08-30"))
